...
//////////////////////////////////////////////////
void MultibeamSonarSystemPlugin::PreUpdate(
...
//////////////////////////////////////////////////
void MultibeamSonarSystemPlugin::PostUpdate(
...
//////////////////////////////////////////////////
void MultibeamSonarSystemPlugin::RemoveSensorEntities(const gz::sim::EntityComponentManager & _ecm)
{
  _ecm.EachRemoved<gz::sim::components::CustomSensor>(
    [&](const gz::sim::Entity & _entity, const gz::sim::components::CustomSensor *) -> bool
    {
      ...
      {
        gzerr << "Internal error, missing odometer for entity [" << _entity << "]" << std::endl;
      }
      return true;
    });
}
...
GZ_ADD_PLUGIN(
  MultibeamSonarSystemPlugin, gz::sim::System, MultibeamSonarSystemPlugin::ISystemPreUpdate,
