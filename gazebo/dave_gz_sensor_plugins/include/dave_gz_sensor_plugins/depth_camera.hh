...
class GZ_SENSORS_DEPTH_CAMERA_VISIBLE MultibeamSonarSensor : public CameraSensor
{
  /// \brief constructor
public:
...
public:
  void OnNewDepthFrame(
    const float * _scan, unsigned int _width, unsigned int _height, unsigned int _channel,
...
private:
  ...
  /// \internal
private:
  std::unique_ptr<MultibeamSonarSensorPrivate> dataPtr;
