...
public:
  void FillMsg(
    msgs::PointCloudPacked & _msg, const float * _pointCloudData, bool _writeToBuffers = false,
...
public:
  ...
  /// \param[in] _height Image height
public:
  void XYZFromPointCloud(
    float * _xyzData, const float * _pointCloudData, unsigned int _width,
    unsigned int _height) const;
